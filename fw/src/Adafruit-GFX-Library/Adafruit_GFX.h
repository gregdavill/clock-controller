...
public:
	...
	virtual void drawLine(int16_t x0, int16_t y0, int16_t x1, int16_t y1, uint16_t color),
		...
		fillRect(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color), fillScreen(uint16_t color),
	...
	void drawCircle(int16_t x0, int16_t y0, int16_t r, uint16_t color),
		...
		setTextSize(uint8_t s), setTextWrap(boolean w), setRotation(uint8_t r), cp437(boolean x = true),
